...
class DStar:
    ...
    def add_square_obstacle(self, center_x, center_y, side_length):
        half_side = side_length // 2
        bottom_left_x = center_x - half_side
        bottom_left_y = center_y - half_side
        top_right_x = center_x + half_side
        top_right_y = center_y + half_side

        # Update your environment's obstacle information
        for i in range(2):
            if i == 0:
                y = bottom_left_y
            elif i ==1:
    ...
    def on_press(self, event):
        ...
        if x < 0 or x > self.x - 1 or y < 0 or y > self.y - 1:
            ...
            self.add_square_obstacle(x, y, 100)
...
def main():
    ...
    s_goal = (700, 1000)
    env1 = env_dstar.Env()
    env1.set_arena_size(1200, 1200)
    # env1.add_square_obs(500, 500, 100)
    # env1.add_square_obs(500, 700, 200)
    # env1.add_square_obs(700, 500, 100)
    # env1.add_square_obs(300, 550, 150)
    # env1.add_square_obs(400, 400, 200)
    # env1.add_square_obs(800, 800, 150)
    # env1.add_square_obs(800, 800, 150)

    dstar = DStar(s_start, s_goal, "euclidean", env1)
    dstar.run()
